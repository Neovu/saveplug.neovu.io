<?php
define('EMAIL_DEFAULT_FROM_ADDRESS', 'webmaster@savenergy.me');
...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    if (isset($_POST['name']) AND isset($_POST['email']) AND isset($_POST['subject']) AND isset($_POST['message'])) {
        $to = 'contato@savenergy.me';//please put ours.
        $from = 'webmaster@savenergy.me';//please put ours.
        ...
        if (mail($to, $subject, $message, 'From: ' . $from)) {
            ...
            echo 'erro|Opa, '.$name.' aconteceu algum problema no envio. Tente direto pelo email contato@savenergy.me!';
        }
    } else {
